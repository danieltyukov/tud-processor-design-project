...
create_clock -period 10.000 -name usb_clk -waveform {0.000 5.000} -add [get_nets usb_clk]
create_clock -period 10.000 -name tio_clkin -waveform {0.000 5.000} -add [get_nets tio_clkin]
create_clock -period 10.000 -name pll_clk1 -waveform {0.000 5.000} -add [get_nets pll_clk1]
