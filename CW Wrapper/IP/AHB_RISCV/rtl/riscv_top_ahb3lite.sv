...
`ifdef USE_PMP_CORE
 ...
 riscv_core_pmp
 #(
    .BOOT_ADDRESS(BOOT_ADDR),
    .PMP_NUM_REGIONS(16),
    .PMP_GRANULARITY(0),
    .AES_EXT(1),
    .DM_EXCEPTION_ADDRESS(32'H0000000D),
    .DM_HALT_ADDRESS(32'H00000000),
    .HART_ID(32'H00000000),
    .MTVEC_ADDRESS(32'H00008081),
    .MIMPID_PATCH(4'B0100)
...
//  .SHARED_FP_DIVSQRT   (     2       )
 ...
 (
  ...
  .fencei_flush_ack_i(fetch_enable_i     ),
  .debug_pc_o()
